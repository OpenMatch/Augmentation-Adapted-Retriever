...
# DATA_NAMES="popQA_kilt_wikipedia_ra_FiD_contriever_MoMA_all_qa_18000"
# DATA_NAMES="marco_qa_msmarco_ra_FiD_contriever"
# DATA_NAMES="popQA_15"
# DATA_NAMES="popQA_kilt_wikipedia_ra_FiD_Tele"

MASTER_PORT=${1-$(expr $RANDOM + 1000)}
# CKPT=${1}
SEED=10

CONFIG_PATH="${WORKING_DIR}/configs/model/t5_base_config.json"
